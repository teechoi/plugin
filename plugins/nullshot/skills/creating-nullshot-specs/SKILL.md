...
4. Present the resulting design in small sections and obtain explicit user approval before persisting it.
...
The terminal state is an approved spec-stage GoalPlan in Nullshot. Continue with `writing-nullshot-plans`; do not start a build.
